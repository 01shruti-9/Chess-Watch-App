...
public class Try extends AppCompatActivity {
    ...
    private static long start_time_in_millis2=600000;
    ...
    private void updateCountDownText(){
        ...
        String timeLeftFormatted = String.format(Locale.getDefault(),"%02d:%02d",minuts,seconds);
        Countdown_Timer.setText(timeLeftFormatted);
        if(minuts==00 && seconds==00){
    ...
    private void updateCountDownText2() {
        ...
        String timeLeftFormatted2 = String.format(Locale.getDefault(), "%02d:%02d", minuts2, seconds2);

        Countdown_Timer2.setText(timeLeftFormatted2);
        if (minuts2==00 && seconds2==00) {
            toast=Toast.makeText(Try.this, "white pieces wins", Toast.LENGTH_LONG);
